...
echo "  4. If this VM is behind a GCP HTTP(S) load balancer, set TRUST_PROXY=1"
echo "     (see server/.env.example) so rate limits use real client IPs from X-Forwarded-For."
